...
namespace API.Controllers
{
    ...
    public class PedidosController : ControllerBase
    {
        ...
        public readonly IPedidoNegocio _IPedidoNegocio = null;
        ...
        {
            _mapper = mapper;
            _IPedidoNegocio = new PedidoNegocio(_mapper);
        }
        #endregion
        ...
        {
            List<PedidoResponse> lst = _IPedidoNegocio.GetAll();
            return Ok(lst);
        }
        ...
        {
            PedidoResponse res = _IPedidoNegocio.GetById(id);
            return Ok(res);
        }
        ...
        {
            PedidoResponse res = _IPedidoNegocio.Create(request);
            return Ok(res);
        }
        ...
        {
            PedidoResponse res = _IPedidoNegocio.Update(entity);
            return Ok(res);
        }
        ...
        {
            int res = _IPedidoNegocio.Delete(id);
            return Ok(res);
        }
        #endregion
    }
